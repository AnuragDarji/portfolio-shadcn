      ...
      <div className="container px-6 mx-auto">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            <div className="w-full h-96 bg-gradient-to-br from-primary/20 to-gray-900 rounded-xl overflow-hidden border border-gray-800">
          ...
          <div>
            ...
            <Button 
              asChild 
              variant="outline" 
              className="gap-2 text-gray-200 border-gray-700 hover:bg-gray-800 hover:text-white hover:border-gray-600"
            >
