      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        >
          <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">
            Get In <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-500 to-green-500 dark:from-emerald-400 dark:to-green-400">Touch</span>
          </h2>
          ...
          >
            <Card className="border border-gray-200 dark:border-gray-700 dark:bg-gray-800/50">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="pt-4">
                  <h3 className="font-medium text-gray-900 dark:text-white mb-3">Connect with me</h3>
            ...
            <Card className="border border-gray-200 dark:border-gray-700 dark:bg-gray-800/50">
              {isSubmitted ? (
                <div className="text-center p-8">
                  ...
                  <CardTitle className="text-2xl text-gray-900 dark:text-white mb-2">Message Sent!</CardTitle>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          className={`bg-gray-50 dark:bg-gray-800 ${errors.name ? "border-red-500" : "border-gray-300 dark:border-gray-700"}`}
                        />
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          className={`bg-gray-50 dark:bg-gray-800 ${errors.email ? "border-red-500" : "border-gray-300 dark:border-gray-700"}`}
                        />
                      ...
                      <div className="space-y-2">
                        ...
                        <Textarea
                          ...
                          className={`bg-gray-50 dark:bg-gray-800 ${errors.message ? "border-red-500" : "border-gray-300 dark:border-gray-700"}`}
                        />
