    ...
    <section className="py-20 bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-950">
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {/* Experience Section */}
          <Card className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:shadow-md dark:hover:shadow-slate-700/50 transition-all">
...
function TimelineItem({
  ...
  return (
    <div className="relative pl-8 pb-8 border-l border-slate-200 dark:border-slate-700 last:border-l-0 last:pb-0 group">
      {/* Dot */}
      <div
        className={`absolute left-0 w-3 h-3 rounded-full ${colors.dot} -translate-x-1/2 group-hover:scale-125 transition-transform`}
      >
        <div
